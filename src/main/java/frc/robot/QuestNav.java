...
/**
 * Until proper support for Vendordeps is added, this file should be taken from the QuestNav
 * GitHub repository @ https://github.com/QuestNav/QuestNav
 * This library should be manually updated when necessary with the latest version.
 * Please leave this comment in-tact
*/
